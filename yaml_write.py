...
class yaml_write:
    ...
    def __write(self,rad_config):
        ...
        #with open(self.sys_config['xray']['path']+'/config.yaml', 'w', encoding='utf-8') as xray_yaml:
